...
import 'package:weather_forecast_app/core/theme/custom_colors.dart';
...
class MaterialTheme {
  ...
  ThemeData light() {
    return theme(lightScheme(), lightCustomColors.harmonized(lightScheme()));
  }
  ...
  ThemeData dark() {
    return theme(darkScheme(), darkCustomColors.harmonized(darkScheme()));
  }
